...
class Main extends React.Component {
  ...
  componentWillMount() {
    ...
    GraphQL.query(ACTIVITIES_QUERY).then(
      action(response => {
    ...
    return (
      <section className={s.main}>
        <div className={s.buttons}>
          <Button className={s.button} onClick={this._onViewPeople}>
            View Contacts
          </Button>
          <Button className={s.button} onClick={this._onAddPerson}>
            Add Contact
          </Button>
        </div>
